...
import com.example.a6diceyahtzee.model.Game
...
class MainViewModel @Inject constructor(): ViewModel() {
    ...
    fun onSetToastShown() {
        Log.d(TAG, "onSetToastShown: starts with ${_toastSetMLB.value}")
        _toastSetMLB.value = null
        Log.d(TAG, "onSetToastShown: ends with ${_toastSetMLB.value}")
    }
}